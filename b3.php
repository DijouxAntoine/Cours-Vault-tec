...
?>
    ...
    <div id="liseret"></div>
        ...
        <div id="contenu">
            ...
            <!-- EXEMPLE DU CANVAS -->
            <canvas><script src="js/canvas.js"></script></canvas>
